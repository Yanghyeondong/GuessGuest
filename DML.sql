...
INSERT INTO User (`user_id`,`age`,`description`,`food`,`gender`,`hate`,`is_solo`,`mbti`,`nickname`,`phone_number`,`visit_place`) VALUES (5,35,'오','Chinese',False,0,False,'I','Jenny','1122','경포대');
INSERT INTO User (`user_id`,`age`,`description`,`food`,`gender`,`hate`,`is_solo`,`mbti`,`nickname`,`phone_number`,`visit_place`) VALUES (6,27,'안뇽','Japanese',True,0,False,'I','Mike','2468','해운대');
INSERT INTO User (`user_id`,`age`,`description`,`food`,`gender`,`hate`,`is_solo`,`mbti`,`nickname`,`phone_number`,`visit_place`) VALUES (7,47,'아','Japanese',False,0,True,'I','Jennie','9876','강릉');
INSERT INTO User (`user_id`,`age`,`description`,`food`,`gender`,`hate`,`is_solo`,`mbti`,`nickname`,`phone_number`,`visit_place`) VALUES (8,38,'바이','Korean',False,0,False,'E','Mickey','1357','중문');
INSERT INTO User (`user_id`,`age`,`description`,`food`,`gender`,`hate`,`is_solo`,`mbti`,`nickname`,`phone_number`,`visit_place`) VALUES (9,21,'어','Chinese',True,0,True,'E','Chris','1212','속초');
INSERT INTO User (`user_id`,`age`,`description`,`food`,`gender`,`hate`,`is_solo`,`mbti`,`nickname`,`phone_number`,`visit_place`) VALUES (10,30,'가이','Korean',True,0,False,'E','Amy','1957','애월');
...
INSERT INTO Reservation (`reservation_id`,`end_date`,`start_date`,`house_Id`,`user_Id`) VALUES (5,'2025-01-08 00:00:00.000000','2025-01-03 00:00:00.000000',2,5);
INSERT INTO Reservation (`reservation_id`,`end_date`,`start_date`,`house_Id`,`user_Id`) VALUES (6,'2025-01-13 00:00:00.000000','2025-01-11 00:00:00.000000',1,6);
INSERT INTO Reservation (`reservation_id`,`end_date`,`start_date`,`house_Id`,`user_Id`) VALUES (7,'2025-01-11 00:00:00.000000','2025-01-09 00:00:00.000000',1,8);
